      ...
      <div class="wrap-login100">
        <form class="login100-form validate-form" action="" method="POST">
          ...
          <div class="text-center p-t-46 p-b-20">
            <span class="txt2">
              or <a href="../indexx.html"><i class="fa fa-arrow-left"></i> Back to Home</a>
            </span> 
          </div>
<!-- 
        ...
        <div class="login100-more" style="background:#a4fed6;">
          <img src="adminMenu/images/login.jpg" style="object-fit: contain">
        </div>
      </div>
    </div>
  </div>
